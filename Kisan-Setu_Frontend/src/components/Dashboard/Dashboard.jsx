...
const Dashboard = () => {
  ...
  const sensors = [
    { id: 1, title: t('soil_moisture'), value: sensorData.moisture, unit: '%', icon: Droplets, colorClass: { bg: 'bg-blue-50', text: 'text-blue-600' }, trend: parseFloat((Math.random() * 5 - 2).toFixed(1)) },
    { id: 2, title: t('ph_level'), value: sensorData.ph, unit: 'pH', icon: FlaskConical, colorClass: { bg: 'bg-purple-50', text: 'text-purple-600' }, trend: parseFloat((Math.random() * 1 - 0.5).toFixed(1)) },
    { id: 3, title: t('temperature'), value: sensorData.temp, unit: '°C', icon: Thermometer, colorClass: { bg: 'bg-orange-50', text: 'text-orange-600' }, trend: parseFloat((Math.random() * 6 - 2).toFixed(1)) },
    { id: 4, title: t('humidity'), value: sensorData.humidity, unit: '%', icon: Wind, colorClass: { bg: 'bg-emerald-50', text: 'text-emerald-600' }, trend: parseFloat((Math.random() * 4 - 2).toFixed(1)) },
  ];
